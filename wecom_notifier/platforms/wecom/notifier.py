...
from .pool import WeComWebhookPool
...
class WeComNotifier:
    ...
    def __init__(
        ...
        self.webhook_pools: Dict[str, WeComWebhookPool] = {}
    ...
    def _get_or_create_pool(self, webhook_urls: List[str]) -> WeComWebhookPool:
        """
        获取或创建Webhook池（带缓存）
