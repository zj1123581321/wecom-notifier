...
from .word_loader import SensitiveWordLoader
from .filter import ContentFilter
from .strategies import create_strategy, ModerationStrategy
...
class ContentModerator:
    ...
    def _check_dependencies(self):
        ...
        try:
            ...
            missing_packages.append("pyahocorasick")

        try:
            import pypinyin
        except ImportError:
            missing_packages.append("pypinyin")
